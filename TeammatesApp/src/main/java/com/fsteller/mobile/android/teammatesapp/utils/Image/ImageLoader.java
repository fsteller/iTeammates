...
public abstract class ImageLoader {
     ...
     */
    public static Bitmap decodeSampledBitmapFromDescriptor(final FileDescriptor fileDescriptor, final int reqWidth, final int reqHeight) {
     ...
     * scrolling smooth.
     * <p/>
     * If work is paused, be sure setCancelWork(false) is called again
     * before your fragments or activity is destroyed (for example during
    ...
    private class BitmapWorkerTask extends AsyncTask<Object, Void, Bitmap> {
        ...
        protected Bitmap doInBackground(final Object... params) {
            ...
            synchronized (mPauseWorkLock) {
                while (mPauseWork && !isCancelled()) try {
                    mPauseWorkLock.wait();
            ...
            final ImageView iView = getAttachedImageView();
            if (!isCancelled() && iView != null) {
                bitmap = processBitmap(iView.getContext(), params[0]);
            }
